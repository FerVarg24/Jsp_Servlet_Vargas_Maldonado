...
public class AgregaCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            out.println("</head>");
            out.println("<body style=\"background-color: #F7FFF7\">");
            ...
            if(accion != null && "Guardar".equals(accion) )
            {
                ...
                out.println("<symbol id=\"check-circle-fill\" fill=\"currentColor\" viewBox=\"0 0 16 16\">");
                out.println("<path d=\"M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z\"/>");
                out.println("</symbol>");
                out.println("<div class=\"alert alert-success d-flex align-items-center\" role=\"alert\">");
                out.println("<svg class=\"bi flex-shrink-0 me-2\" width=\"24\" height=\"24\" role=\"img\" aria-label=\"Success:\"><use xlink:href=\"#check-circle-fill\"/></svg>");
                out.println("<div>");
